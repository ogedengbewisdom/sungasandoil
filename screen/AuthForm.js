...
const AuthForm = () => {
  ...
  return (
        <Box as={motion.div} initial={{y: 100, opacity: 0}} animate={{y: -30, opacity: 1}} exit={{y: 100, opacity: 0}} transition={{delay: 0.55, duration:2}} width={"90%"} maxW={"45rem"} margin={"5rem auto"}>
