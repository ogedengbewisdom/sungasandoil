...
const About = () => {
  ...
  return (
    ...
    <Box mt={"2rem"}>
        ...
        <SimpleGrid spacing={4} templateColumns={{base: "1fr", md: "1fr 1fr", lg: "5fr 4fr"}} m={"auto"} justifyContent={"center"} alignItems={"center"} width={"80%"} mt={{lg: "5rem"}}>
            <Card boxShadow={"none"} >
           ...
           <Text  fontStyle={"normal"} lineHeight={"166%"} fontSize={{base: "1rem", md:"1.1rem", lg: "1.2rem"}} fontWeight={"600"} color={"#000"} mb={{base: "2rem"}} mr={{lg: "5rem"}}>At Sun Oil & Gas, we are more than just a business;
            ...
            <Card boxShadow={"none"} margin={'2re'}>
