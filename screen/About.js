...
const About = () => {
  ...
  return (
    ...
    <Box m={"2rem"}>
        ...
        <SimpleGrid spacing={4} templateColumns={{base: "1fr", md: "1fr 1fr", lg: "5fr 4fr"}}>
            <Card boxShadow={"none"}>
           ...
           <Text  fontStyle={"normal"} lineHeight={"166%"} fontSize={{base: "1rem", md:"1.1rem", lg: "1.5rem"}} fontWeight={"600"} color={"#000"} mb={{base: "2rem"}}>At Sun Oil & Gas, we are more than just a business;
            ...
            <Card boxShadow={"none"} width={"70%"}>
            <Image  src="/images/shutterstock.png" alt='shutterstock' width="300" height="350" objectFit={"cover"} borderRadius='3rem' />
            </Card>
        </SimpleGrid>
    </Box>
  )
