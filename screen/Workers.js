...
const Workers = () => {
  ...
  return (
    <Box display={"flex"} mt={"1rem"} justifyContent={"space-between"} alignItems={"center"} position={"relative"}>
        <Box  ml={{base: "1.38rem",md: "3.5rem", lg: "5.31rem"}}>
            <Box mb={"1.6rem"} width={{md: "50%"}}>
        ...
        <Image as={motion.img} initial={{opacity: 0}} animate={{y: [0,-40, 0], opacity: 1}} transition={{delay: 1, duration: 7}} src="/icons/elipse2.png" alt="Elipse" width={"100"}  height={"50"} position={"absolute"} top={0} right={20} zIndex={4}  />
        <Image as={motion.img} initial={{opacity: 0}}  animate={{y: [0,40,-110, 0], opacity: [0.3, 0.6, 1]}} transition={{delay: 0.55, duration:10}} src="/images/workerss.png" alt="Sun Oil & Gas" width={"300"} height={"300"}  position={"absolute"} top={18} right={10} zIndex={5} />
        ...
        <Image as={motion.img} initial={{opacity: 0}}  animate={{y: [0,40,-110, 0], opacity: [0.3, 0.6, 1]}} transition={{delay: 0.55, duration:10}} src="/icons/oilrig.png"  alt="oilrig" width={"100"} height={"130"} position={"absolute"} bottom={50} right={0} zIndex={1} />
        </Box>
